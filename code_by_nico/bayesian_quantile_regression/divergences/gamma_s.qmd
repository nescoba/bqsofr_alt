...
q50 <- brm(bf(y ~ x, sigma ~ x - 1, ligam ~ s(x),  tau = .5), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 500, control = list(adapt_delta = 0.99), cores = 4, seed = 123)
summary(q50)
```
...
q50 <- brm(bf(y ~ 1, sigma ~ x - 1, ligam ~ s(x),  tau = .5), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 500, control = list(adapt_delta = 0.99), cores = 4, seed = 123)
summary(q50)
```
