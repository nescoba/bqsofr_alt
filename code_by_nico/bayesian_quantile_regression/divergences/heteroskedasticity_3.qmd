...
q25 <- brm(bf(y ~ x, sigma ~ log(x) - 1, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 100, control = list(adapt_delta = 0.99), cores = 4, prior = priors)
summary(q25)
```
...
q50 <- brm(bf(y ~ x, sigma ~ log(x) - 1, tau = .5), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 2000, control = list(adapt_delta = 0.97), cores = 4, prior = priors)
summary(q50)
```
...
q75 <- brm(bf(y ~ x, sigma ~ log(x) - 1, tau = .75), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 2000, control = list(adapt_delta = 0.97), cores = 4, prior = priors)
summary(q75)
```
...
q25n <- brm(bf(y ~ x, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 2000, control = list(adapt_delta = 0.97), cores = 4, prior = priors)
summary(q25n)
```
...
q50n <- brm(bf(y ~ x, tau = .5), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 2000, control = list(adapt_delta = 0.97), cores = 4, prior = priors)
summary(q50n)
```
...
q75n <- brm(bf(y ~ x, tau = .75), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 2000, control = list(adapt_delta = 0.97), cores = 4, prior = priors)
summary(q75n)
```
...
q25 <- brm(bf(y ~ x, sigma ~ log(x2) - 1, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 2000, control = list(adapt_delta = 0.97), cores = 4, prior = priors)
summary(q25)
```
...
q50 <- brm(bf(y ~ x, sigma ~ log(x2) - 1, tau = .5), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 2000, control = list(adapt_delta = 0.97), cores = 4, prior = priors)
summary(q50)
```
...
q75 <- brm(bf(y ~ x, sigma ~ log(x2) - 1, tau = .75), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 2000, control = list(adapt_delta = 0.97), cores = 4, prior = priors)
summary(q75)
```
