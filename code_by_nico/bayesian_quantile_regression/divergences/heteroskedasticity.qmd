...
Generating synthethic data with mean 0 and $\mathrm{sd} = .1 + x$

```{r}
N <- 1000
x <- runif(N, 0, 1)
y <- rnorm(N, mean = 0, sd = .1 + x)
...
q25 <- brm(bf(y ~ x, sigma ~ x, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q25)
```
...
q50 <- brm(bf(y ~ x, sigma ~ x, tau = .5), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q50)
```
...
q75 <- brm(bf(y ~ x, sigma ~ x, tau = .75), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q75)
```
...
q25n <- brm(bf(y ~ x, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q25n)
```
...
q50n <- brm(bf(y ~ x, tau = .5), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q50n)
```
...
q75n <- brm(bf(y ~ x, tau = .75), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q75n)
```
...
```{r}
tq25 <- qnorm(.25, mean = 0, sd = .1 + x)
tq50 <- qnorm(.5, mean = 0, sd = .1 + x)
tq75 <- qnorm(.75, mean = 0, sd = .1 + x)
```
...
q25 <- brm(bf(y ~ x2, sigma ~ x2, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q25)
```
...
q50 <- brm(bf(y ~ x2, sigma ~ x2, tau = .5), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q50)
```
...
q75 <- brm(bf(y ~ x2, sigma ~ x2, tau = .75), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q75)
```
...
q25n <- brm(bf(y ~ x2, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 10, control = list(adapt_delta = 0.97), cores = 4)
summary(q25n)
```
...
q50n <- brm(bf(y ~ x2, tau = .5), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q50n)
```
...
q75n <- brm(bf(y ~ x2, tau = .75), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q75n)
```
...
```{r}
tq25 <- qnorm(.25, mean = 0, sd = .1 + x^2)
tq50 <- qnorm(.5, mean = 0, sd = .1 + x^2)
tq75 <- qnorm(.75, mean = 0, sd = .1 + x^2)
```
