...
q25 <- brm(bf(y ~ x, sigma ~ log(x)-1, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q25)
```
...
q50 <- brm(bf(y ~ x, sigma ~ log(x)-1, tau = .5), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q50)
```
...
q75 <- brm(bf(y ~ x, sigma ~ log(x)-1, tau = .75), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q75)
```
...
q25 <- brm(bf(y ~ x2, sigma ~ log(x2)-1, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q25)
```
...
q50 <- brm(bf(y ~ x2, sigma ~ log(x2)-1, tau = .5), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q50)
```
...
q75 <- brm(bf(y ~ x2, sigma ~ log(x2)-1, tau = .75), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 1000, control = list(adapt_delta = 0.97), cores = 4)
summary(q75)
```
