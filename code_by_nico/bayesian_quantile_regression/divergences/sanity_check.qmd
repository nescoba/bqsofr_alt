...
GAL2 <- custom_family(
    "GAL2",
    dpars = c("mu", "sigma", "ligam", "tau"), links = c("identity", "identity", "identity", "identity"),
    lb = c(NA, 0, Bd[1] * .99, 0), ub = c(NA, NA, Bd[2] * .99, 1), type = "real"
)
q50 <- brm(bf(y ~ x, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 500, control = list(adapt_delta = 0.99), cores = 4, seed = 123)
summary(q50)
```
...
Estimates: $\sigma = .03$, $\gamma = 1.34$.
No divergences

Hairy caterpillars 
Degeneracy between $\sigma$ and $\gamma$ 



## log link function for $\sigma$
...
## Non constant $\sigma$, identity link function
...
q50 <- brm(bf(y ~ x, sigma ~ x - 1, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 500, control = list(adapt_delta = 0.99), cores = 4, seed = 123)
summary(q50)
```
...
## Non constant $\sigma$, identity link function, I tell it the value of $\gamma$
...
q50 <- brm(bf(y ~ x, sigma ~ x - 1, ligam = 1.34, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 500, control = list(adapt_delta = 0.99), cores = 4, seed = 123)
summary(q50)
```
...
## Non constant $\sigma$, identity link function, I tell it the value of $\gamma$ and that the location is constant
...
q50 <- brm(bf(y ~ 1, sigma ~ x - 1, ligam = 1.34, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 500, control = list(adapt_delta = 0.99), cores = 4, seed = 123)
summary(q50)
```
...
## Non constant $\sigma$, identity link function, I tell it the value of $\gamma$ and that the location is constant and priors


```{r}
p <- prior(normal(0, .1), class = b, coef = x, dpar = sigma)
```
...
q50 <- brm(bf(y ~ 1, sigma ~ x - 1, ligam = 1.34, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 500, control = list(adapt_delta = 0.99), cores = 4, seed = 123, prior = p)
summary(q50)
```
...
## Non constant $\sigma$, log link function
...
q50 <- brm(bf(y ~ x, sigma ~ log(x), tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 500, control = list(adapt_delta = 0.99), cores = 4, seed = 123)
summary(q50)
```
...
q50 <- brm(bf(y ~ 1, sigma ~ log(x) - 1, tau = .5), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 500, control = list(adapt_delta = 0.99), cores = 4, seed = 123)
summary(q50)
```
...
## Non constant $\sigma$, log link function, I tell it no location and $\gamma$
...
q50 <- brm(bf(y ~ 1, sigma ~ log(x) - 1, ligam = 1.34, tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 500, control = list(adapt_delta = 0.99), cores = 4, seed = 123)
summary(q50)
```
...
## Non constant $\sigma$, log link function, I tell it no location, smooth gamma
...
q50 <- brm(bf(y ~ 1, sigma ~ log(x) - 1, ligam = s(x), tau = .25), data = synthetic, family = GAL2, stanvars = stanvars2, chains = 2, iter = 500, control = list(adapt_delta = 0.99), cores = 4, seed = 123)
summary(q50)
```
